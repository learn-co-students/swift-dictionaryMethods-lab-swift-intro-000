 ...
 */
// write your code here
var starWardsDroids = ["R2-D2", "C-3P0", "IG- 88", "BB-8"]
 ...
 */
// write your code here
for droids in starWardsDroids.enumerated() {
    print (droids)
}
starWardsDroids.remove(at: 2)
print(starWardsDroids)
 ...
 */
// write your code here
var starWarsCharacters = ["Heroes": starWarsHeroes, "Villains": starWarsVillains, "Droids": starWardsDroids]
 ...
 */
var keyCount = starWarsCharacters.count
print(keyCount)
...
} else { print("There are \(starWarsCharacters.count) items in the dictionary.")
}
 ...
 */
// write your code here
var starWardsJedi = ["Yoda", "Obi-Wan Kenobi", "Mace Windu"]
 ...
 */
// write your code here
if starWarsCharacters.updateValue(starWardsJedi, forKey: "Jedi") == nil {
