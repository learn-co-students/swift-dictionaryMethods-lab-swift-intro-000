...
let updateOrAdded = starWarsCharacters.updateValue(starWarsJedi, forKey: "Jedi")
if updateOrAdded == nil{
 ...
 */
let existedOrNot = starWarsCharacters.removeValue(forKey: "Bounty Hunters")
if existedOrNot == nil {
...
if let thing = starWarsCharacters["Jedi"] {
print(thing)
}
