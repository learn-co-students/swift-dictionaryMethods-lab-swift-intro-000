 ...
 */
var starWarsHeros = ["Luke Skywalker", "Princess Leia", "Han Solo", "Rey"]
 ...
 */
var starWarsVilliains = ["Darth Vader", "Emperor Palpatine"]
 ...
 */
starWarsVilliains.append("Kylo Ren")
 ...
 */
var starWarsCharacters = ["Heroes": starWarsHeros, "Villiains": starWarsVilliains, "Droids": starWarsDroids]
 ...
 */
for item in starWarsCharacters.keys {
    print(item)
}
 ...
 */
if let check = starWarsCharacters.removeValue(forKey: "Bounty Hunters") {
