 ...
 */
var starWarsCharacters = ["Heroes":starWarHeroes,"Villains":starWarsVillains,"Droids":starWarsDroids]
 ...
 */
let updateResult = starWarsCharacters.updateValue(starWarsJedi, forKey: "Jedi")
if updateResult == nil{
 ...
 */
let removeResults = starWarsCharacters.removeValue(forKey: "Bounty Hunters")

if (removeResults == nil){
