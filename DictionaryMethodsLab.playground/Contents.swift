...
//returns nil because it's a new entry to the dictionary
 ...
 */
for characterCategories in starWarsCharacters.keys {
    print(characterCategories)
}
 ...
 */
let keysCount = starWarsCharacters.count
print(keysCount)
/*: question11
 ...
 */
let addJedi = starWarsCharacters.updateValue(starWarsJedi, forKey: "Jedi")
 ...
 */
let removeBountyHunters = starWarsCharacters.removeValue(forKey: "Bounty Hunters")
