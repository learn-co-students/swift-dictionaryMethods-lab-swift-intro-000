 ...
 */
// write your code here
var numberOfKeyInDict = 0
for keys in starWarsCharacters {
    numberOfKeyInDict += 1
}
print(numberOfKeyInDict)
...
if starWarsCharacters.isEmpty {
    ...
    print("There are \(starWarsCharacters.count) items in the dictonary.")
}
 ...
 */
// write your code here
if starWarsCharacters.removeValue(forKey: "Bounty Hunter") != nil {
